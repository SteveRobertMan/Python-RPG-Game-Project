...
STATUS_DESCS = {
    ...
    "Hopeless Blossom":"Upon taking damage from a skill, take extra fixed damage equal to Count/2 (min 1), then reduce count by 1. When the unit “General Of The Ten Thousand Blossom Brotherhood | Kaoru Hana” is present, tally the amount of damage this effect does to any unit, then the unit appends skills based on the following tallies:\n10 Damage: Move As A “Phantom [幻影]”\n30 Damage: The Great Ocean Receives a Hundred Rivers [海纳百川有容乃大]\nAt 40+ Damage, reset the tally on turn start. Max Count: 99",
    "Spirit Blade Unsealed [靈刃解封]":"This effect cannot be removed by any means. All allies of this unit Agape and Eros Base Damage +(Count). Start of turn, Heal for [(Max HP-HP)/10)*Count] (min 0, max 8). Critical Hit Damage +(15*Count)%. Max Count: 3"
}
