...
cloud_sword_1 = StatusEffect("Cloud Sword [云]", "[bold chartreuse1][云][/bold chartreuse1]", 0, "Apply the following effects when owning at least 1 Count:\nCritical Hit damage +20%, tally amount of Critical Hits this unit performs throughout battle (Max 9). On next Critical Hit with an Agape element skill, does not count towards Tally; instead multiplies Final Damage by ×(Tally+1), resets the Tally, then removes this status effect. Max Count: 1", duration=1, type="BUFF")
