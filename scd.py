...
pierce_affinity_1 = StatusEffect("Pierce Affinity", "[light_yellow3]➾[/light_yellow3]", 0, "Take +Base Damage from any skill that can inflict Pierce Affinity and -Base Damage from any skill that cannot inflict Pierce Affinity based on stack amount. Upon taking damage, reduce count by 1. Max Count: 5", duration=1, type="DEBUFF")
pierce_affinity_2 = StatusEffect("Pierce Affinity", "[light_yellow3]➾[/light_yellow3]", 0, "Take +Base Damage from any skill that can inflict Pierce Affinity and -Base Damage from any skill that cannot inflict Pierce Affinity based on stack amount. Upon taking damage, reduce count by 1. Max Count: 5", duration=2, type="DEBUFF")
pierce_affinity_3 = StatusEffect("Pierce Affinity", "[light_yellow3]➾[/light_yellow3]", 0, "Take +Base Damage from any skill that can inflict Pierce Affinity and -Base Damage from any skill that cannot inflict Pierce Affinity based on stack amount. Upon taking damage, reduce count by 1. Max Count: 5", duration=3, type="DEBUFF")
