...
def get_enemy_database():
    ...
    ib_s2_desc = "Prioritizes targeting units who are not “Benikawa” or “Shigemura”\n       [On Use] If this unit has 1-2 Invisibility, lose all Invisibility, then this unit takes +5 Final Damage this turn and the next turn (this effect cannot stack)\n       [On Hit] Gain 8 Poise Potency"
    ...
    # Passives
    ib_p1 = Passive("Thorn / Outcast", "When this unit’s HP reaches 500 and has no Invisibility, ends the battle. Deals +30% Base Damage against units who are not “Benikawa” or “Shigemura”. Deals -50% Base Damage and takes +50% Base Damage from units who are “Benikawa” or “Shigemura”", "PASSIVE_IBARA_THORN", color="purple4")
